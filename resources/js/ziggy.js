const Ziggy = {
    ...
    routes: {
        ...
        'questions.show': { uri: 'questions\/{id}', methods: ['GET', 'HEAD'], parameters: ['id'] },
        'questions.store': { uri: 'questions', methods: ['POST'] },
        subjects: { uri: 'subjects', methods: ['GET', 'HEAD'] },
        topics: { uri: 'topics', methods: ['GET', 'HEAD'] },
        exports: { uri: 'exports', methods: ['GET', 'HEAD'] },
